...
type VirtualMeshStatus struct {
	...
	// A copy of the shared_trust object currently being rotated to. If the shared trust object in the spec
	// is different from this, we need to start a new rotation.
	RotationTarget *SharedTrust `protobuf:"bytes,7,opt,name=rotation_target,json=rotationTarget,proto3" json:"rotation_target,omitempty"`
}
...
func (x *VirtualMeshStatus) GetRotationTarget() *SharedTrust {
	if x != nil {
		return x.RotationTarget
	}
	return nil
}
...
var file_github_com_solo_io_gloo_mesh_api_networking_v1_virtual_mesh_proto_rawDesc = []byte{
	...
	0x74, 0x68, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x22, 0xe1, 0x05, 0x0a, 0x11, 0x56, 0x69, 0x72, 0x74,
	...
	0x52, 0x0a, 0x0f, 0x72, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x74, 0x61, 0x72, 0x67,
	0x65, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x6e, 0x65, 0x74, 0x77, 0x6f,
	0x72, 0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x6d, 0x65, 0x73, 0x68, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e,
	0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e, 0x53, 0x68, 0x61, 0x72, 0x65, 0x64, 0x54, 0x72,
	0x75, 0x73, 0x74, 0x52, 0x0e, 0x72, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x61, 0x72,
	0x67, 0x65, 0x74, 0x1a, 0x67, 0x0a, 0x0b, 0x4d, 0x65, 0x73, 0x68, 0x65, 0x73, 0x45, 0x6e, 0x74,
...
var file_github_com_solo_io_gloo_mesh_api_networking_v1_virtual_mesh_proto_depIdxs = []int32{
	...
	3,  // 13: networking.mesh.gloo.solo.io.VirtualMeshStatus.rotation_target:type_name -> networking.mesh.gloo.solo.io.SharedTrust
	...
	18, // 18: networking.mesh.gloo.solo.io.VirtualMeshSpec.Federation.east_west_ingress_gateway_selectors:type_name -> common.mesh.gloo.solo.io.IngressGatewaySelector
